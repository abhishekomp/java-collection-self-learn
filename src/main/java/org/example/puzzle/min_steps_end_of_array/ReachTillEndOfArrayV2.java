...
public class ReachTillEndOfArrayV2 {
    ...
    /**
     * Calculated the minimum number of jumps required to reach the end of the array
     * @param inputArr Given input integer array
     * @return  int value of minimum jumps to reach the end of the array
     */
    public int minNumberOfJumpsToReachEnd(int[] inputArr) {
        if(!canReachTillEndOfArray(inputArr)) {
            return -1;
        }
        return calcMinNumberOfJumpsToReachEnd(inputArr, false);
    }
     ...
     * @return  int value of minimum jumps to reach the end of the array
     */
    public int minNumberOfJumpsToReachEnd(int[] inputArr, boolean landExactly) {
        if(!canReachTillEndOfArray(inputArr)) {
            return -1;
        }
        return calcMinNumberOfJumpsToReachEnd(inputArr, landExactly);
    }
     ...
     */
    private int calcMinNumberOfJumpsToReachEnd(int[] inputArr, boolean landExactly) {
//        if(!canReachTillEndOfArray(inputArr)) {
//            return -1;
//        }
            ...
            if(i == lastJumpIndex) {
                ...
                if(landExactly){
                    if(coverage == destination) {
                        System.out.println("Reach directly on the end element");
                        return totalJumps;
                    }
                } else {
                    if(coverage >= destination) {
    ...
    public static void main(String[] args) {
        ...
        ReachTillEndOfArrayV2 runner = new ReachTillEndOfArrayV2();
...
//        System.out.println("result = " + result);
        ...
        int jumpsToReachEnd = runner.minNumberOfJumpsToReachEnd(inputArr, true);
